...
public class StreamPractice {
     ...
     */
    public int findMinEvenNumber(@NotNull List<String> numbers) {
     ...
     * return the average of all odd numbers from the list or throw
     * NoSuchElementException.
     * But before that subtract 1 from each element on an odd
     * position (having the odd index).
     */
